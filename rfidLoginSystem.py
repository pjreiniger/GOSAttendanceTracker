...
##        self.tab4.layout.addWidget(self.label4)
        ...
        self.clearButton4.clicked.connect(
            lambda: self.message4.setText("")
        )
        ...
        self.instructions5 = QLabel("Type your name below to log your presense here today.")
        ...
        self.clearButton5.clicked.connect(
            lambda: self.message5.setText("")
        )
...
##            self.thread.finished.connect(self.input.clear)
    ...
    def logVisit(self):
        ...
        if (team ==""):
            self.message4.setText("Please include a team number. If unaffiliated, write n/a.")
            return None
